...
(function () {
    ...
    function initFire() {
        ...
        function initShader() {
            ...
            var textureLoader = new THREE.TextureLoader();
            textureLoader.load('./resources/flame.png', t => _shader.uniforms.uMap.value = t);
        }
    ...
    function initEmbers() {
        ...
        function initShader() {
            ...
            var textureLoader = new THREE.TextureLoader();
            textureLoader.load('./resources/ember.png', t => _shader.uniforms.uMap.value = t);
        }
    ...
    function initHaze() {
        ...
        function initShader() {
            ...
            var textureLoader = new THREE.TextureLoader();
            textureLoader.load('./resources/haze.png', t => _shader.uniforms.uMask.value = t);
        }
